...
remaining_balance = 0
id_trx = None
total_inserted = 0  # Total uang yang dikonversi dari pulsa
    ...
    if pulse_gap > PULSE_TIMEOUT:
        ...
        if corrected_pulses:
            ...
            if remaining_balance <= 0:
                ...
                log_transaction(f"⏳ Menunggu uang tambahan... (Remaining: Rp.{remaining_balance})")
